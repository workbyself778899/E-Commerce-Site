...
const Order = () => {
  ...
  const fetchOrders = async () => {
    try {
      const res = await axios.get('https://e-commerce-site-5h4d.vercel.app/order/all', { headers: { 'auth-token': token } })
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await axios.delete(`https://e-commerce-site-5h4d.vercel.app/order/delete/${id}`, { headers: { 'auth-token': token } })
  ...
  const handleUpdateStatus = async (id, status) => {
    try {
      const res = await axios.put(`https://e-commerce-site-5h4d.vercel.app/order/update/${id}`, { order_status: status }, { headers: { 'auth-token': token } })
  ...
  const handleTogglePayment = async (id, current) => {
    try {
      ...
      const res = await axios.put(`https://e-commerce-site-5h4d.vercel.app/order/update/${id}`, { payment_status: next }, { headers: { 'auth-token': token } })
