...
const Dashboard = () => {
  ...
  //Count total user
    const User = async()=>{
      const res =await axios.get("https://e-commerce-site-5h4d.vercel.app/user/all-user")
      setCountUser(res.data.data)
    }

    // count total Order 
    const Order = async()=>{
        const res = await axios.get("https://e-commerce-site-5h4d.vercel.app/order/all",{
